// header/navigation bar
    ...
    // Contact Us Today Reveal on Scroll
window.addEventListener("scroll", () => {
    let sectionReveal = document.querySelectorAll(".contact-us-today");
    ...
    for (const section of sectionReveal) {
        ...
        if (sectionTop < deviceHeight - yTranslate) {
            section.classList.add("contact-us-today-reveal");
        }
        else {
            section.classList.remove ("contact-us-today-reveal");
        }
    }
})
